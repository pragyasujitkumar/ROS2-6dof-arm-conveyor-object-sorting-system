...
#include "conveyorbelt_msgs/msg/detail/conveyor_belt_state__rosidl_typesupport_fastrtps_c.h"
...
using _ConveyorBeltState__ros_msg_type = conveyorbelt_msgs__msg__ConveyorBeltState;
...
size_t get_serialized_size_conveyorbelt_msgs__msg__ConveyorBeltState(
  const void * untyped_ros_message,
...
static uint32_t _ConveyorBeltState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_conveyorbelt_msgs__msg__ConveyorBeltState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_conveyorbelt_msgs
size_t max_serialized_size_conveyorbelt_msgs__msg__ConveyorBeltState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = conveyorbelt_msgs__msg__ConveyorBeltState;
    is_plain =
      (
...
static size_t _ConveyorBeltState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_conveyorbelt_msgs__msg__ConveyorBeltState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conveyorbelt_msgs, msg, ConveyorBeltState)() {
