...
{
  new (message_memory) conveyorbelt_msgs::srv::ConveyorBeltControl_Request(_init);
}

void ConveyorBeltControl_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<conveyorbelt_msgs::srv::ConveyorBeltControl_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConveyorBeltControl_Request_message_member_array[1] = {
  {
    ...
    offsetof(conveyorbelt_msgs::srv::ConveyorBeltControl_Request, power),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConveyorBeltControl_Request_message_members = {
  "conveyorbelt_msgs::srv",  // message namespace
  "ConveyorBeltControl_Request",  // message name
  1,  // number of fields
  sizeof(conveyorbelt_msgs::srv::ConveyorBeltControl_Request),
...
{
  return &::conveyorbelt_msgs::srv::rosidl_typesupport_introspection_cpp::ConveyorBeltControl_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, conveyorbelt_msgs, srv, ConveyorBeltControl_Request)() {
  return &::conveyorbelt_msgs::srv::rosidl_typesupport_introspection_cpp::ConveyorBeltControl_Request_message_type_support_handle;
}
...
void ConveyorBeltControl_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) conveyorbelt_msgs::srv::ConveyorBeltControl_Response(_init);
}

void ConveyorBeltControl_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<conveyorbelt_msgs::srv::ConveyorBeltControl_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConveyorBeltControl_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(conveyorbelt_msgs::srv::ConveyorBeltControl_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConveyorBeltControl_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(conveyorbelt_msgs::srv::ConveyorBeltControl_Response),
...
{
  return &::conveyorbelt_msgs::srv::rosidl_typesupport_introspection_cpp::ConveyorBeltControl_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, conveyorbelt_msgs, srv, ConveyorBeltControl_Response)() {
  return &::conveyorbelt_msgs::srv::rosidl_typesupport_introspection_cpp::ConveyorBeltControl_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers ConveyorBeltControl_service_members = {
  "conveyorbelt_msgs::srv",  // service namespace
  "ConveyorBeltControl",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<conveyorbelt_msgs::srv::ConveyorBeltControl>()
...
get_service_type_support_handle<conveyorbelt_msgs::srv::ConveyorBeltControl>()
{
  ...
  auto service_type_support =
    &::conveyorbelt_msgs::srv::rosidl_typesupport_introspection_cpp::ConveyorBeltControl_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, conveyorbelt_msgs, srv, ConveyorBeltControl)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<conveyorbelt_msgs::srv::ConveyorBeltControl>();
}
